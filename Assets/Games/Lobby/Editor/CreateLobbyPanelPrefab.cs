...
public class CreateLobbyPanelPrefab
{
    ...
    {
        if (AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Games/Lobby/Resources/UI/LobbyPanel.prefab") == null)
            Create();
    }

    public static void Create()
    {
        if (!AssetDatabase.IsValidFolder("Assets/Games/Lobby/Resources/UI"))
        {
            if (!AssetDatabase.IsValidFolder("Assets/Games/Lobby/Resources"))
                AssetDatabase.CreateFolder("Assets/Games/Lobby", "Resources");
            AssetDatabase.CreateFolder("Assets/Games/Lobby/Resources", "UI");
        }
        ...
        // Save
        string path = "Assets/Games/Lobby/Resources/UI/LobbyPanel.prefab";
