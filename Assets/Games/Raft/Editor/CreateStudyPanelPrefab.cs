...
public class CreateStudyPanelPrefab
{
    ...
    {
        if (AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Games/Raft/Resources/UI/StudyPanel.prefab") == null)
            Create();
    }
    ...
    public static void Create()
    {
        ...
        // Save
        string path = "Assets/Games/Raft/Resources/UI/StudyPanel.prefab";
    ...
    {
        if (!AssetDatabase.IsValidFolder("Assets/Games/Raft/Resources/UI"))
        {
            if (!AssetDatabase.IsValidFolder("Assets/Games/Raft/Resources"))
                AssetDatabase.CreateFolder("Assets/Games/Raft", "Resources");
            AssetDatabase.CreateFolder("Assets/Games/Raft/Resources", "UI");
        }
    }
